...
/* most X stuff will be included with Xlib.h, but a few things require
 * other headers, like Xmd.h, keysym.h, etc. */
#include <X11/Xlib.h>
#include <stdio.h>
#include <stdlib.h>
...
int main() {
	...
	/* we use this to save the pointer's state at the beginning of
	 * the move/resize.
	 */
